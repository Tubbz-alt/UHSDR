...
//[QBS] remove pwr output limits for out of band          pf_bandvalue = 12; // because no factor is known outside bands
        }               // I never will use this function (DF8OE)
        else
        {
//[QBS] remove pwr output limits for out of band           pf_bandvalue = 3; // use very low value in case of wrong call to this function
        }
    }
    else
    {
